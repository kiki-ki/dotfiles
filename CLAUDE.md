...
- Claude Code skills live in `dot_claude/skills/`. Their layer prefixes (`principle-`, `meta-`, `work-`) are described in `dot_claude/skills/README.md`, along with where each skill came from.
