...
| 名前 | 要約 | いつ適用するか |
|---|---|---|
| principle-laziness-protocol | 先に消し、最小の変更に寄せる | 追加・リファクタ・書き直しの順番を決めるとき、diff の大きさを評価するとき、抽象化・レイヤー・シグナルの引き回しを足したくなったとき |
| principle-prove-it-works | 代理指標ではなく本物で確かめ、結果を示す | 作業を終えて完了と言う前に |
...
| principle-foundational-thinking | データ構造と足場を先に決め、ドメインを構造に埋め込む | ロジックを書く前、型やデータ構造を選ぶとき、足場と機能の順番を決めるとき、状態を持つロジックを書くとき、分岐や同じ形の前提が散らばっているとき |
